...
- Create new workflow skills in `.github/skills/`
...
2. **Use Template** — Follow the appropriate template (`/new-custom-agent`, `/new-prompt-file`, `/new-instructions-file`)
...
- Skill files live in `.github/skills/<skill-name>/SKILL.md`
