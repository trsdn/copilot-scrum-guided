...
The agent proposes; the human disposes. Every ceremony has a consent gate. The human drives scope, accepts deliverables, and contributes observations. The agent brings throughput, consistency, and tireless execution.

*...while keeping the agent empowered to execute freely within approved scope.*
...
Every retrospective must evaluate the process itself — not just the deliverables. Both human and agent contribute observations. Agents, prompts, and workflows are living artifacts. What caused friction gets automated. What failed gets fixed.
...
5. **Consent gates are a feature, not friction.** The PO reviewing scope, approving plans, and accepting deliverables isn't bureaucracy — it's quality assurance at the strategic level. The agent executes better when it knows exactly what was approved.
