...
Full details in `docs/architecture/ADR.md`. Record all architectural decisions there.
...
### Scrum Ceremonies (PO-Guided)

| Command | Ceremony | PO Gate |
|---------|----------|---------|
| `/sprint-planning` | Sprint Planning | PO selects scope |
| `/sprint-start` | Sprint Execution | PO says "go" |
| `/sprint-review` | Sprint Review | PO accepts/rejects |
| `/sprint-retro` | Sprint Retro | Interactive with PO |

### Other Skills

| Skill | Description |
|-------|-------------|
| `agent-memory` | Save, recall, organize persistent memories |
...
| `writing-plans` | Implementation plans before code |
